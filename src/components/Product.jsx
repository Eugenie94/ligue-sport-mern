...
export default function Product() {
      ...
      const handleAddProductSubmit = async (e) => {
            e.preventDefault();
            try {
                  const response = await axios.post('http://localhost:4000/admin/products', newProduct);
      ...
      const deleteProduct = async (productId) => {
            try {
                  await axios.delete(`http://localhost:4000/admin/products/${productId}`);
      ...
      const handleEditProductSubmit = async (e) => {
            ...
            try {
                  await axios.put(
                        `http://localhost:4000/admin/products/${editedProduct._id}`,
                        editedProduct
                  );
