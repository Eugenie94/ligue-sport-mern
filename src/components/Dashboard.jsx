...
export default function Dashboard() {
  return (
    <div className="dashboard">
      ...
      <p className="dashboard-description">Bienvenue dans le Tableau de bord de Amazone. Cette interface vous permettra, en tant qu'admin, de gérer les éléments de la base de données.</p>
